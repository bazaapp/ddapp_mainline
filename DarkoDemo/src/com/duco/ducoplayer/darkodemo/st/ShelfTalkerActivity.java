package com.duco.ducoplayer.darkodemo.st;
...
public class ShelfTalkerActivity extends Activity {
	...
	private void showError(String error)  {
		final AlertDialog alertDialog = new AlertDialog.Builder(ShelfTalkerActivity.this).create();
