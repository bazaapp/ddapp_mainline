...
public class ScreenSaverActivity extends Activity {
    ...
    public boolean onTouchEvent(android.view.MotionEvent event) {
    	...
    	Intent anotherActivityIntent = new Intent(ScreenSaverActivity.this, MainActivity.class);
	...
	private void showError(String error)  {
		final AlertDialog alertDialog = new AlertDialog.Builder(ScreenSaverActivity.this).create();
